...
STATIC_ROOT = os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), 'teenrcia_static/')
STATIC_URL = 'https://youthrcia.jmorris.webfactional.com/static/'
STATICFILES_DIRS = ( os.path.join(BASE_DIR, 'static', 'site',), )

ALLOWED_HOSTS = ['youthrcia.jmorris.webfactional.com',
                 'www.youthrcia.jmorris.webfactional.com']
